...
public class PanelAlmuerzo extends JPanel {

	/**
	 * Create the panel.
	 */
	public PanelAlmuerzo() {
...
setBorder(new MatteBorder(1, 1, 1, 1, (Color) new Color(192, 192, 192)));
		...
		lblImgProd5.setIcon(new ImageIcon(PanelDesayuno.class.getResource("/img_rest_catalogo/pancho.jpg")));
		lblImgProd5.setBounds(0, 0, 351, 192);
		panel_p1_1.add(lblImgProd5);
		
		JLabel lblNewLabel_2_1 = new JLabel("Super Pancho");
		...
		lblImgProd6.setIcon(new ImageIcon(PanelDesayuno.class.getResource("/img_rest_catalogo/sandwichmila.jpg")));
		lblImgProd6.setBounds(0, 0, 336, 192);
		panel_p1_1_1.add(lblImgProd6);
		
		JLabel lblNewLabel_2_1_1 = new JLabel("Sandwich de milanesa, lechuga y tomate");
		lblNewLabel_2_1_1.setForeground(Color.BLACK);
		lblNewLabel_2_1_1.setFont(new Font("Dialog", Font.PLAIN, 15));
		lblNewLabel_2_1_1.setBounds(30, 203, 296, 34);
		...
		lblImgProd8.setIcon(new ImageIcon(PanelDesayuno.class.getResource("/img_rest_catalogo/pebete.jpg")));
		...
		lblNewLabel_2_1_3.setBounds(30, 203, 266, 34);
		...
		lblImgProd5_1.setIcon(new ImageIcon(PanelDesayuno.class.getResource("/img_rest_catalogo/pancho.jpg")));
		...
		panel_p1_1_1_1.setBorder(new MatteBorder(1, 1, 1, 1, (Color) new Color(192, 192, 192)));
		panel_p1_1_1_1.setBackground(new Color(199, 57, 29));
		panel_p1_1_1_1.setBounds(0, 292, 351, 298);
		add(panel_p1_1_1_1);
		
		JLabel lblImgProd6_1 = new JLabel("");
		lblImgProd6_1.setIcon(new ImageIcon(PanelDesayuno.class.getResource("/img_rest_catalogo/sandwichmila.jpg")));
		lblImgProd6_1.setBounds(0, 0, 351, 192);
		panel_p1_1_1_1.add(lblImgProd6_1);
		
		JLabel lblNewLabel_2_1_1_1 = new JLabel("Sandwich de milanesa, lechuga y tomate");
		lblNewLabel_2_1_1_1.setForeground(Color.BLACK);
		lblNewLabel_2_1_1_1.setFont(new Font("Dialog", Font.PLAIN, 15));
		lblNewLabel_2_1_1_1.setBounds(30, 203, 283, 34);
		...
		lblImgProd8_1.setIcon(new ImageIcon(PanelDesayuno.class.getResource("/img_rest_catalogo/pebete.jpg")));
		lblImgProd8_1.setBounds(0, 0, 345, 192);
		panel_p1_1_3_1.add(lblImgProd8_1);
		
		JLabel lblNewLabel_2_1_3_1 = new JLabel("Pebete de salame y queso");
		lblNewLabel_2_1_3_1.setForeground(Color.BLACK);
		lblNewLabel_2_1_3_1.setFont(new Font("Dialog", Font.PLAIN, 15));
		lblNewLabel_2_1_3_1.setBounds(30, 203, 272, 34);
		...
		lblImgProd5_2.setIcon(new ImageIcon(PanelDesayuno.class.getResource("/img_rest_catalogo/pancho.jpg")));
		lblImgProd5_2.setBounds(0, 0, 351, 192);
		panel_p1_1_4.add(lblImgProd5_2);
		
		JLabel lblNewLabel_2_1_4 = new JLabel("Super Pancho");
		lblNewLabel_2_1_4.setForeground(Color.BLACK);
		lblNewLabel_2_1_4.setFont(new Font("Dialog", Font.PLAIN, 15));
		lblNewLabel_2_1_4.setBounds(30, 203, 170, 34);
		...
		lblImgProd6_2.setIcon(new ImageIcon(PanelDesayuno.class.getResource("/img_rest_catalogo/sandwichmila.jpg")));
		lblImgProd6_2.setBounds(0, 0, 336, 192);
		panel_p1_1_1_2.add(lblImgProd6_2);
		
		JLabel lblNewLabel_2_1_1_2 = new JLabel("Sandwich de milanesa, lechuga y tomate");
		lblNewLabel_2_1_1_2.setForeground(Color.BLACK);
		lblNewLabel_2_1_1_2.setFont(new Font("Dialog", Font.PLAIN, 15));
		lblNewLabel_2_1_1_2.setBounds(30, 203, 273, 34);
