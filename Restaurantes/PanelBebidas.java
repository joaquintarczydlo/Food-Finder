...
setBorder(new MatteBorder(1, 1, 1, 1, (Color) new Color(192, 192, 192)));
		...
		lblImgProd5.setIcon(new ImageIcon(PanelDesayuno.class.getResource("/img_rest_catalogo/ades.jpg")));
		...
		lblImgProd6.setIcon(new ImageIcon(PanelDesayuno.class.getResource("/img_rest_catalogo/LATA.jpg")));
		lblImgProd6.setBounds(0, 0, 336, 192);
		panel_p1_1_1.add(lblImgProd6);
		
		JLabel lblNewLabel_2_1_1 = new JLabel("Lata Coca-Cola Original 354ml");
		lblNewLabel_2_1_1.setForeground(Color.BLACK);
		lblNewLabel_2_1_1.setFont(new Font("Dialog", Font.PLAIN, 15));
		lblNewLabel_2_1_1.setBounds(30, 203, 247, 34);
		...
		lblImgProd8.setIcon(new ImageIcon(PanelDesayuno.class.getResource("/img_rest_catalogo/ades.jpg")));
		lblImgProd8.setBounds(0, 0, 345, 192);
		panel_p1_1_3.add(lblImgProd8);
		
		JLabel lblNewLabel_2_1_3 = new JLabel("Ades Soja 1L");
		lblNewLabel_2_1_3.setForeground(Color.BLACK);
		lblNewLabel_2_1_3.setFont(new Font("Dialog", Font.PLAIN, 15));
		lblNewLabel_2_1_3.setBounds(30, 203, 170, 34);
		...
		lblImgProd5_1.setIcon(new ImageIcon(PanelDesayuno.class.getResource("/img_rest_catalogo/LATA.jpg")));
		lblImgProd5_1.setBounds(0, 0, 351, 192);
		panel_p1_1_2.add(lblImgProd5_1);
		
		JLabel lblNewLabel_2_1_2 = new JLabel("Lata Coca-Cola Original 354ml");
		lblNewLabel_2_1_2.setForeground(Color.BLACK);
		lblNewLabel_2_1_2.setFont(new Font("Dialog", Font.PLAIN, 15));
		lblNewLabel_2_1_2.setBounds(30, 203, 279, 34);
		...
		lblImgProd6_1.setIcon(new ImageIcon(PanelDesayuno.class.getResource("/img_rest_catalogo/ades.jpg")));
		lblImgProd6_1.setBounds(0, 0, 351, 192);
		panel_p1_1_1_1.add(lblImgProd6_1);
		
		JLabel lblNewLabel_2_1_1_1 = new JLabel("Ades Soja 1L");
		lblNewLabel_2_1_1_1.setForeground(Color.BLACK);
		lblNewLabel_2_1_1_1.setFont(new Font("Dialog", Font.PLAIN, 15));
		lblNewLabel_2_1_1_1.setBounds(30, 203, 170, 34);
		...
		lblImgProd8_1.setIcon(new ImageIcon(PanelDesayuno.class.getResource("/img_rest_catalogo/LATA.jpg")));
		lblImgProd8_1.setBounds(0, 0, 345, 192);
		panel_p1_1_3_1.add(lblImgProd8_1);
		
		JLabel lblNewLabel_2_1_3_1 = new JLabel("Lata Coca-Cola Original 354ml");
		lblNewLabel_2_1_3_1.setForeground(Color.BLACK);
		lblNewLabel_2_1_3_1.setFont(new Font("Dialog", Font.PLAIN, 15));
		lblNewLabel_2_1_3_1.setBounds(30, 203, 265, 34);
		...
		lblImgProd5_2.setIcon(new ImageIcon(PanelDesayuno.class.getResource("/img_rest_catalogo/ades.jpg")));
		lblImgProd5_2.setBounds(0, 0, 351, 192);
		panel_p1_1_4.add(lblImgProd5_2);
		
		JLabel lblNewLabel_2_1_4 = new JLabel("Ades Soja 1L");
		...
		lblImgProd6_2.setIcon(new ImageIcon(PanelDesayuno.class.getResource("/img_rest_catalogo/LATA.jpg")));
		lblImgProd6_2.setBounds(0, 0, 345, 192);
		panel_p1_1_1_2.add(lblImgProd6_2);
		
		JLabel lblNewLabel_2_1_1_2 = new JLabel("Lata Coca-Cola Original 354ml");
