...
public class PanelDesayuno extends JPanel {
	

	/**
	 * Create the panel.
	 */
	public PanelDesayuno() {
		...
		lblImgProd6.setIcon(new ImageIcon(PanelDesayuno.class.getResource("/img_rest_catalogo/mediaLunas.jpg")));
		...
		lblNewLabel_2_1_3.setBounds(30, 203, 261, 34);
		...
		panel_p1_1_2.setBorder(new MatteBorder(1, 1, 1, 1, (Color) Color.BLACK));
		...
		panel_p1_1_1_1.setBorder(new MatteBorder(1, 1, 1, 1, (Color) Color.BLACK));
		panel_p1_1_1_1.setBackground(new Color(199, 57, 29));
		panel_p1_1_1_1.setBounds(0, 292, 351, 298);
		add(panel_p1_1_1_1);
		
		JLabel lblImgProd6_1 = new JLabel("");
		lblImgProd6_1.setIcon(new ImageIcon(PanelDesayuno.class.getResource("/img_rest_catalogo/mediaLunas.jpg")));
		lblImgProd6_1.setBounds(0, 0, 351, 192);
		panel_p1_1_1_1.add(lblImgProd6_1);
		
		JLabel lblNewLabel_2_1_1_1 = new JLabel("Medialuna con  J&Q");
		...
		panel_p1_1_3_1.setBorder(new MatteBorder(1, 1, 1, 1, (Color) Color.BLACK));
		...
		lblNewLabel_2_1_3_1.setBounds(30, 203, 229, 34);
		...
		panel_p1_1_4.setBorder(new MatteBorder(1, 1, 1, 1, (Color) Color.BLACK));
		...
		panel_p1_1_1_2.setBorder(new MatteBorder(1, 1, 1, 1, (Color) Color.BLACK));
		panel_p1_1_1_2.setBackground(new Color(199, 57, 29));
		panel_p1_1_1_2.setBounds(1015, 292, 345, 298);
		add(panel_p1_1_1_2);
		
		JLabel lblImgProd6_2 = new JLabel("");
		lblImgProd6_2.setIcon(new ImageIcon(PanelDesayuno.class.getResource("/img_rest_catalogo/mediaLunas.jpg")));
		lblImgProd6_2.setBounds(0, 0, 345, 192);
		panel_p1_1_1_2.add(lblImgProd6_2);
		
		JLabel lblNewLabel_2_1_1_2 = new JLabel("Medialuna con  J&Q");
